...
namespace Calc
{
	internal class Program
	{
		static void Main(string[] args)
		{
			...
			expression=expression.Replace('.', ',');//Метод Replase()заменяет первый указанный символ
													//вторым 
			...
			try
			{
				...
				//Метод IndexDfAny возвращает индекс символа , в данном случае символа из массива delimiters
